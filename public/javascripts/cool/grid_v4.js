...
BindingFieldDefsIntegerFields (fielddef_obj) { _Field_Defs = fielddef_obj; }
GenOriginalData: function () {
...
ArrayPast2Table (tablename, fieldname, fill_data) {
...
BindingFunctions: async function (editbtn, savebtn, readmodbtn) {
