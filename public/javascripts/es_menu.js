...
var exports_m0 = [
    ...
    { n: 'AMDPV5富士施樂', lnk:'http://192.168.123.232/adminportal/'},    
...
$(document).ready(function () {
    ...
    if (profileUserName) {
        ...
        $("#inter_mnu").append("<li><a href='/internal/sdlc'>支援-SDLC</a></li>");
        ...
        if (profileUserName.indexOf('hoipouwan') >= 0 || profileUserName.indexOf('lammou') >= 0) {
           ...
           $("#excu_sys_mnu").append("<li><a href='/internal/studentPhoto/'>行政-升級及新生相片</a></li>");
        }
